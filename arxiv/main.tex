...
quality penalty. Cycle 82 addresses whether intermediate CSER ($0.30$--$0.50$) produces
lower code quality than high CSER ($> 0.80$): Condition B\_partial (CSER $= 0.444$,
symmetric-domain tags) passes the gate but yields reduced quality relative to Condition A
(CSER $= 1.000$), providing the first evidence for a continuous CSER--quality spectrum
above the execution threshold.
