...
\bibitem{wei2024survey}
  Wei, J. et al. (2024). A Survey on Multi-Agent LLM Systems: Architectures, Coordination, and Emergence. \textit{arXiv:2402.01680}.

\bibitem{zhuge2024agent}
  Zhuge, M. et al. (2024). Agent-as-a-Graph: Emergent Graph Structure in Multi-Agent Collaboration Networks. \textit{arXiv:2406.13385}.

\bibitem{chan2024chateval}
  Chan, C. et al. (2024). ChatEval: Towards Better LLM-based Evaluators through Multi-Agent Debate. \textit{ICLR 2024, arXiv:2308.07201}.

\bibitem{liu2024dynamic}
  Liu, X. et al. (2024). Dynamic LLM-Agent Networks: An LLM-based Approach for Autonomous Multi-Agent Collaboration. \textit{arXiv:2310.02170}.
