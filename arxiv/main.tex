...
co-evolved a shared KG over 89+ cycles. Each cycle consists of Agent A's contribution
...
Amplification judge & \multicolumn{2}{l}{\texttt{gemini-2.5-flash-preview}} & Google \\
\bottomrule
\end{tabular}
