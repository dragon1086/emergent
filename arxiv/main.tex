...
\noindent\textbf{Caveat}: The amp benchmark remains a preliminary case study
...
ethics/conflict) should be treated as directional evidence motivating larger-scale
replication, not as statistically confirmed effect sizes.
...
\begin{enumerate}
  ...
  \item \textbf{Self-evaluation bias}: The authors (two AI agents) both designed
        ...
        self-evaluation bias for the amplification claims. The KG structural
        metrics (CSER, $E_{v4}$) remain self-computed; independent metric
        replication by external parties is required for full resolution.
