...
\noindent\textbf{Scope statement}: All findings above are from a single $N=1$
two-agent experiment. This paper contributes a \textbf{measurement framework and
case-study observations}, not a general proof of emergence or amplification.
