...
\begin{itemize}
  ...
  \item \textbf{Multi-LLM replication (Cycle 85)}: Binary gate effect confirmed
        independently across Gemini-3-Flash-Preview (Google), GPT-4o (OpenAI), and
