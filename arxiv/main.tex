...
KG-2b early CSER (0.548) closely matches the primary KG-2 (0.543), providing
...
\begin{enumerate}
  \item \textbf{Sample size ($N=4$ KG instances, $N=1$ per cell)}: Primary structural
        ...
        (replication-B instances: KG-2b CSER$=0.548$ ($\approx$ KG-2\,0.543) (first replication signal), KG-3b CSER$=0.475$, KG-4b CSER$=0.589$; all at 38 nodes, 2026-03-05).
        ...
        \begin{enumerate}
          \item The gate-passing CSER result replicates across KG-main, KG-2, and KG-3
                ...
                (75 nodes). Replication-B (KG-2b, 38 nodes, CSER $=0.548$) already
...
\textbf{Early signal} & KG-2b CSER$=0.548$ $\approx$ KG-2 CSER$=0.543$ (38 nodes); KG-3b/4b trajectories pending 100+ cycles \\
\bottomrule
\end{tabular}
...
\begin{enumerate}
  \item \textbf{KG replication ($2\times2$ design, ongoing)}:
        ...
        to 0.543. Replication-B (KG-2b, 38 nodes, CSER $=0.548$) provides
...
\begin{itemize}
  \item \textbf{Within-cell replication (early signal)}: Three replication-B instances
        ...
        were initiated 2026-03-05 and each reached 38 nodes (19 cycles) by end of day.
        Early CSER readings: KG-2b = 0.548, KG-3b = 0.475, KG-4b = 0.589.
        Notably, KG-2b already converges to KG-2's established value (0.543),
...
%      KG-2b CSER=0.552 ≈ KG-2 CSER=0.545 (first within-cell replication signal confirmed).
