...
\begin{enumerate}
  ...
  \item \textbf{Within-cell replication signal}: Independent replication-B instances
        ...
        KG-2b CSER$=0.500$ tracks KG-2 CSER$=0.534$ (same declining trajectory, $N=68$ nodes),
...
KG-2b CSER (0.500) tracks KG-2 (0.534) on the same declining trajectory, providing
...
\begin{enumerate}
  \item \textbf{Sample size ($N=4$ KG instances, $N=1$ per cell)}: Primary structural
        ...
        (replication-B instances: KG-2b CSER$=0.500$ (tracking KG-2\,0.534), KG-3b CSER$=0.487$, KG-4b CSER$=0.546$; all at 68 nodes, 2026-03-05).
        ...
        identical-model pairing. Replication-B (KG-2b, 68 nodes, CSER $=0.500$) tracks the same declining
        ...
        \begin{enumerate}
          \item The gate-passing CSER result replicates across KG-main, KG-2, and KG-3
                ...
                (95 nodes). Replication-B (KG-2b, 68 nodes, CSER $=0.500$) tracks this declining trajectory---first within-cell replication of the same-model
                echo-chamber effect.
...
\textbf{Early signal} & KG-2b CSER$=0.500$ tracking KG-2 CSER$=0.534$ (same echo-chamber trajectory, 68 nodes); KG-3b/4b trajectories pending 100+ cycles \\
\bottomrule
\end{tabular}
...
\begin{enumerate}
  \item \textbf{KG replication ($2\times2$ design, ongoing)}:
        ...
        to 0.534. Replication-B (KG-2b, 68 nodes, CSER $=0.500$) tracks the same declining trajectory, providing
...
%      KG-2b CSER=0.500 tracking KG-2 CSER=0.534 (same declining trajectory, 68 nodes) (first within-cell replication signal confirmed).
