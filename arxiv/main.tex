...
Each cell contains $N=1$ KG; within-cell replication and domain generalization
require further study. Claims are limited to this experimental setting.
...
\begin{enumerate}
  \item \textbf{Sample size ($N=4$ KG instances, $N=1$ per cell)}: Primary structural
        ...
        agent configurations. \emph{Each cell contains $N=1$ KG; within-cell
        replication and domain generalization require further study.} No claim
        ...
        replication ($N=1$ KG per cell, 4 cells total). While within-cell replication
        remains outstanding, cross-cell consistency provides directional evidence
