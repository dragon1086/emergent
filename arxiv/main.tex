...
\begin{enumerate}
  \item \textbf{Sample size ($N=4$ KG instances, $N=1$ per cell)}: Primary structural
        ...
        (replication-B instances initiated 2026-03-05; within-cell trajectories ongoing).
...
%  (1) Within-cell replication: N=7 KG instances total (4 original + 3 replication-B initiated
%      2026-03-05). Target: ≥30 cycles per replication-B instance for trajectory comparison.
