...
\begin{itemize}
  \item \textbf{Within-cell replication (early signal)}: Three replication-B instances
        ...
        were initiated 2026-03-05 and have reached 68 nodes (34 cycles).
        Current CSER readings (68 nodes each): KG-2b = 0.500, KG-3b = 0.487, KG-4b = 0.546.
        Notably, KG-2b (0.500) tracks KG-2's declining trajectory (current: 0.534),
