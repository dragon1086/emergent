...
\begin{itemize}
  \item \textbf{Multi-seed replication}: Independent KG runs with preregistered protocols,
        ...
        beyond this single experimental instance.
...
%  (1) Multi-seed replication: ≥3 independent KG runs; currently N=4 KG instances
%      at 60+ cycles each (ongoing). Target: ≥100 cycles per instance.
%  (2) amp benchmark: add second judge or significance test (Wilcoxon) on
